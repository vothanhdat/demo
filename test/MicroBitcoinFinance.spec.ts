...
import { IUniswapV2Pair, IUniswapV2Pair__factory, MicroBitcoinFinance, MicroBitcoinFinance__factory } from '../typechain'
...
describe('WBNB POOL', () => {
  ...
  beforeEach(async function () {
    ...
    token = await new MicroBitcoinFinance__factory(wallet)
      .deploy()
